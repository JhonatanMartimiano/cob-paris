                        ...
                        <div class="card-body">
                            <div>
                                <div class="d-flex justify-content-center">
                                    <form class="form-inline mb-1 ajax_off" action="<?= url('/admin/dash/home'); ?>"
                                          method="post">
                                        <input type="hidden" name="firstForm" value="true">
                                        <div class="form-group">
                                            <input type="date" name="start_date" value="<?= $fstartDate; ?>"
                                                   class="form-control">
                                        </div>
                                        <div class="form-group mx-2">
                                            <input type="date" name="due_date" value="<?= $fdueDate; ?>"
                                                   class="form-control">
                                        </div>
                                        <div class="form-group mr-2">
                                            <select name="situation" class="form-control">
                                                <option value="">Selecionar</option>
                                                <option <?= ($fsituation === 'finished') ? 'selected' : ''; ?>
                                                        value="finished">Liquidado
                                                </option>
                                                <option <?= ($fsituation === 'due') ? 'selected' : ''; ?> value="due">
                                                    Vencido
                                                </option>
                                                <option <?= ($fsituation === 'towin') ? 'selected' : ''; ?>
                                                        value="towin">A Vencer
                                                </option>
                                                <option <?= ($fsituation === 'negotiation') ? 'selected' : ''; ?>
                                                        value="negotiation">Acordado
                                                </option>
                                                <option <?= ($fsituation === 'lowForPayment') ? 'selected' : ''; ?>
                                                        value="lowForPayment">Baixa para Pagamento
                                                </option>
                                                <option <?= ($fsituation === 'courts') ? 'selected' : ''; ?>
                                                        value="courts">Juízado
                                                </option>
                                                <option <?= ($fsituation === 'protested') ? 'selected' : ''; ?>
                                                        value="protested">Protestado
                                                </option>
                                                <option <?= ($fsituation === 'protestedAgreed') ? 'selected' : ''; ?>
                                                        value="protestedAgreed">Protestado Porém Acordado
                                                </option>
                                                <option <?= ($fsituation === 'open') ? 'selected' : ''; ?> value="open">
                                                    Em Aberto
                                                </option>
                                                <option <?= ($fsituation === 'all') ? 'selected' : ''; ?> value="all">
                                                    Todas
                                                </option>
                                            </select>
                                        </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <form class="form-inline mb-1" action="<?= url('/admin/dash/home'); ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="date" name="start_date" value="<?= $sstartDate; ?>"
                                               class="form-control">
                                    </div>
                                    <div class="form-group mx-2">
                                        <input type="date" name="due_date" value="<?= $sdueDate; ?>"
                                               class="form-control">
                                    </div>
                                    <button type="submit" class="btn btn-danger">BUSCAR</button>
                                </form>
