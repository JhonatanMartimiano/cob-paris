        ...
        <div class="side-app">
            <div class="page-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= url('/admin/charges/home'); ?>">Pagos</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Criar Pago</li>
                </ol>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card m-b-20">
                        <div class="card-header">
                            <h3 class="card-title">Criar Pago</h3>
                        </div>
                        <div class="card-body">
                            <form action="<?= url("/admin/charges/charge/{$ticket->id}"); ?>" method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control mask-money" name="amount_paid" value="<?= $ticket->amount_paid; ?>" disabled>
                                    </div>
                                    <div class="form-group col-md-4">
